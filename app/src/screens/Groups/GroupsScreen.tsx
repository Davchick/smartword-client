  ...
  const handleDeletePress = () => {
    ...
    closeActionMenu(() => {
      ...
      setTimeout(() => {
        Alert.alert(
          'Удалить словарь?',
          `Словарь "${group.name}" и все ${group.word_count} слов будут удалены навсегда — восстановить их не получится.`,
          [
        ...
        renderItem={({ item }) => (
          ...
          >
            <View style={styles.cardContent}>
              ...
              <Text style={[styles.wordCount, { color: colors.muted }]}>{item.word_count} слов</Text>
            </View>
            <TouchableOpacity
          ...
          {actionMenuGroup && (
            <View style={styles.sheetPreview}>
              ...
              <Text style={[styles.sheetPreviewMeta, { color: colors.muted }]}>
                {actionMenuGroup.word_count} слов
