      ...
      >
        ...
        <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <TouchableOpacity
            style={[styles.menuRow, { borderBottomWidth: 1, borderBottomColor: colors.border }]}
            onPress={() =>
              Alert.alert('Конфиденциальность', 'Мы не передаём ваши данные третьим лицам. Все данные хранятся в зашифрованном виде.')
            }
            activeOpacity={0.7}
          >
            <View style={[styles.menuIcon, { backgroundColor: colors.primaryDim }]}>
            ...
            <Text style={[styles.menuText, { color: colors.text }]}>Конфиденциальность</Text>
            <ChevronRight color={colors.muted} size={18} />
          </TouchableOpacity>
